...
class Compquiz1 extends StatefulWidget {
  ...
  const Compquiz1({super.key, required this.quizId});

  @override
  _Compquiz1State createState() => _Compquiz1State();
}

class _Compquiz1State extends State<Compquiz1> {
  ...
  void goToNextQuestion() {
    if (currentQuestionIndex < questions.length - 1) {
      setState(() {
        ...
        _seconds = 30; // Reset timer for the next question (or fetch from Firestore if needed)
      ...
      body: isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            // Dynamically render answer buttons
            Wrap(
